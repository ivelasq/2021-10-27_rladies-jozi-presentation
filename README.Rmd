...
I will be discussing tables as tools for visualizing data and walking through creating a table in R using the {gt} package.

`r emo::ji("calendar")` [Event Page](https://www.meetup.com/rladies-johannesburg/events/281522272/)

`r emo::ji("memo")` [Presentation](https://bit.ly/jozipres)

`r emo::ji("computer")` [RStudio Cloud (requires login)](https://bit.ly/joziproject)
